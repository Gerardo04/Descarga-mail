...
const opDir = "C:\Users\gustavo.herrera\Desktop\attachments";
const email = "escanersdta2020@gmail.com";
const password = "sistemasdigitales";
const port = 993;
...
var paraObj = {
  ...
  var onEnd = (result) => {
    if (result.errors || result.error) {
        ...
        if(reTry < 4) {
            console.log("retrying....", reTry++);
            return downloadEmailAttachments(paraObjPdf, onEnd);
        }else console.log("Failed to download attachment")
    }else console.log("done ------>");
}
downloadEmailAttachments(paraObjPdf, onEnd);